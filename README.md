...
1. Buat file .github/workflows/snake.yml di repo bhagaskuro/bhagaskuro
2. Pakai action: Platane/snk
3. Snake akan otomatis generate berdasarkan contribution graph kamu
-->